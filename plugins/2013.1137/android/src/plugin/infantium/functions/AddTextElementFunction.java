...
public class AddTextElementFunction implements NamedJavaFunction {
	private static final String FUNCTION_NAME = "addTextElement";
	 ...
	 * 4: String text
	 * 5: String language (optional). "" if empty.
	 */
	public int addTextElement(LuaState L) {
		...
		try {
			...
			String text = L.checkString(5);
			String lang = L.checkString(6);

...
public class AddTappingGoalFunction implements NamedJavaFunction {
	private static final String FUNCTION_NAME = "addTappingGoal";
	 ...
	 */
	public int addTappingGoal(LuaState L) {
		...
		try {
			...
			String element_to_tap = L.checkString(5);

...
public class SetSubcontentFunction implements NamedJavaFunction {
	private static final String FUNCTION_NAME = "setSubContentUUID";
	 ...
	 */
	public int setSubContentUUID(LuaState L) {
		InfantiumResponse resp = InfantiumResponse.EmptyField;
		
		try {
			String subcontent_uuid = L.checkString(1);
			
			resp = LuaLoader.infantium.setSubContentUUID(subcontent_uuid);

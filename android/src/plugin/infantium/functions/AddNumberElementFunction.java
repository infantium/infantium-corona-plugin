...
public class AddNumberElementFunction implements NamedJavaFunction {
	private static final String FUNCTION_NAME = "addNumberElement";
	 ...
	 * 4: Integer value
	 */
	public int addNumberElement(LuaState L) {
		...
		try {
			...
			Integer value = L.checkInteger(5);

			NumberElement ele = new NumberElement(element_id);

...
public class AddPaintedElementFunction implements NamedJavaFunction {
	private static final String FUNCTION_NAME = "addPaintedElement";
	 ...
	 */
	public int addPaintedElement(LuaState L) {

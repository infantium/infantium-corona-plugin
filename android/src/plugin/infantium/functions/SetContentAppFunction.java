...
public class SetContentAppFunction implements NamedJavaFunction {
	private static final String FUNCTION_NAME = "setContentAppUUID";
	 ...
	 */
	public int setContentAppUUID(LuaState L) {
		InfantiumResponse resp = InfantiumResponse.EmptyField;
		
		try {
			String contentapp_uuid = L.checkString(1);
